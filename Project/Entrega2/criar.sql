...
CREATE TABLE Evento (
    ...
    --receitas_finais será implementado na terceira entrega
...
CREATE TABLE Funcionario_Interno (
    ...
    FOREIGN KEY (
        ...
        numero_espaco,
        numero_piso
    ) REFERENCES Estabelecimento ON UPDATE RESTRICT ON DELETE RESTRICT
);
...
CREATE TABLE Casa_de_Banho (
    ...
    --tamanho será implementado na terceira entrega
...
CREATE TABLE Funcionario_Externo (
    ...
    --tipo_servico será implementado na terceira entrega
);
...
CREATE TABLE Bilhete (
    ...
    hora_entrada            INTEGER
                            NOT NULL
                            CHECK ((hora_entrada >= 0 AND hora_entrada <= 22)),
    ...
    hora_saida              INTEGER
                            CHECK ((hora_saida >= 0 AND hora_saida <= 22)),
